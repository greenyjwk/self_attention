...
from ViT_2 import VisionTransformer
...
class U_Net(nn.Module):
    ...
    def forward(self, x):
        ...
        print("before ViT xe52.shape", xe52.shape)
        
        # N, C, H, W = X.shape
        xe52 = self.mhsa(xe52)
        print("after ViT xe52.shape", xe52.shape)


        print("after ViT xe52.shape reshape")
        xe52_reshaped = xe52.reshape(xe52.shape[0], 1024, 16, 16)
        print("xe52_reshaped.shape", xe52_reshaped.shape)

        # Deocder
        xu1 = self.upconv1(xe52_reshaped)
